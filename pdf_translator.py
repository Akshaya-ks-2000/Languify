...
pdf_path = r'C:\Internship\Langify_projects\Subhas Chandra Bose.pdf'
...
pdfmetrics.registerFont(TTFont('NotoSansMalayalam', r"C:\Internship\PDF_Converter\NotoSansMalayalam-VariableFont_wdth,wght.ttf"))  # Replace with the actual path

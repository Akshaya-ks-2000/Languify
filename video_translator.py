...
# Input video file
input_video_file = r'C:\Internship\Langify_projects\PM Speech.mp4'
# Output audio file
...
# else:
#     # Handle the case when hindi_text is None
...
video = VideoFileClip(r"C:\Internship\Langify_projects\PM Speech.mp4")  # Replace with your original video file
